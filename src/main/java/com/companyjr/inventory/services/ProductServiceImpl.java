...
import com.companyjr.inventory.dao.ICategoryDao;
import com.companyjr.inventory.dao.IProductDao;
...
import com.companyjr.inventory.util.Util;

@Service
public class ProductServiceImpl implements IProductService {
	
	//OTRA FORMA DE INJECCION DE DEPENDENCIA - CONSTRUCTOR
	...
	public ResponseEntity<ProductResponseRest> save(Product product, Long categoryId) {
		...
		try {
			...
			if (productSaved != null) {
				...
				response.setMetadata("respuesta no", "00", "Producto guardado");
			} else {
		...
		try {
			...
			if (productSearch.isPresent()) {
				...
				if (productToUpdate != null) {
					...
					response.getProduct().setProducts(list);
					response.setMetadata("respuesta no", "00", "Producto actualizado");
				} else {
